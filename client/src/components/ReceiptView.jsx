...
export default function ReceiptView({ student, payment, onClose }) {
  ...
  return (
    <div className="receipt-overlay" style={{ position: 'fixed', inset: 0, background: 'rgba(27,42,74,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16, zIndex: 80 }} onClick={onClose}>
      ...
      `}</style>
      <div className="receipt-card" onClick={e => e.stopPropagation()} style={{ background: '#fff', borderRadius: 10, padding: 28, width: '100%', maxWidth: 440, maxHeight: '90vh', overflowY: 'auto', border: '1px solid #1B2A4A' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderTop: '1px solid #E3DCC9', paddingTop: 14, marginBottom: 4 }}>
          <p style={{ fontSize: 11, color: '#6B6458', margin: 0, maxWidth: 200 }}>This is a computer-generated receipt and does not require a physical signature.</p>
          <div style={{ textAlign: 'center' }}>
            <div style={{ width: 90, borderBottom: '1px solid #1B2A4A', marginBottom: 4, height: 24 }}></div>
