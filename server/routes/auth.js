...
router.post('/login', async (req, res) => {
  ...
  try {
    ...
    // Email is sent in the background — a slow or failing mail server should never
    // delay or break a successful login.
...
router.post('/forgot-password', async (req, res) => {
  try {
    ...
    res.json({ success: true, message: 'Reset link emailed!' });
  } catch (err) {
